...
<head>
    ...
    <x-seo
        title="Arcn Solutions — Software que impulsiona negócios"
        description="Arcn Solutions cria produtos de software modernos para negócios que querem crescer. Delivery, gestão, APIs e automação."
        path="/"
        keywords="software para negócios, sistema de delivery, gestão de pedidos, APIs, automação, Arcn Solutions"
    />
